...
export default function CartItemCard({productImg, productName, productOptions, productPrice, deleteIcon, imgAdd, imgRemove, quantity, onDeleteItem, onIncrement, onDecrement}){
    return(
